...
class _CommentScreenState extends State<CommentScreen> {
  ...
  Future postComment() async {
    ...
    initialValue.isNotEmpty
        ? await firestoreService.updateCommentReplies(
            action: 'add',
            masterCommentID: masterCommentID,
    ...
    return firestoreService.updatePostCommentCount(
        action: 'add', postID: widget.post.postID);
  }
              ...
              ListTile(
                ...
                onTap: () async {
                  ...
                  if (comment.isReply) {
                    ...
                    await firestoreService.updateCommentReplies(
                        masterCommentID: comment.masterCommentID,
                        replyID: comment.commentID);
                    ...
                    firestoreService.updatePostCommentCount(
                        postID: widget.post.postID);
                  }
  ...
  StreamBuilder<QuerySnapshot> commentList() {
    return StreamBuilder<QuerySnapshot>(
      stream: FirestoreService.commentsCollection
          .where('postID', isEqualTo: widget.post.postID)
          .snapshots(),
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          List<QueryDocumentSnapshot> postComments = snapshot.data.docs;
          return postComments.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    Comment comment =
                        Comment.fromMap(queryDocumentSnapshot.data());
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          // user profile
                                          GestureDetector(
                                            child: commentOwner.profilePhoto !=
                                                    null
                                                ? Padding(
                                                    padding:
                                                                  ...
                                                                  leading:
                                                                    ...
                                                                    onTap: () {
                                                                      Navigator.push(
                                                                          context,
                                                                          CupertinoPageRoute(
                                                                              builder: (context) => Profile(userID: comment.ownerID)));
                                                                    },
                                                                  ),
                                                                  onLongPress:
                                                                      () {
